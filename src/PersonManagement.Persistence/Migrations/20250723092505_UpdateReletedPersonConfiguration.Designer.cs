...
namespace PersonManagement.Persistence.Migrations
{
    ...
    [Migration("20250723092505_UpdateReletedPersonConfiguration")]
    partial class UpdateReletedPersonConfiguration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PersonManagement.Domain.Entities.RelatedPerson", b =>
                {
                    ...
                    b.HasOne("PersonManagement.Domain.Entities.Person", "RelatedToPerson")
                        .WithMany()
